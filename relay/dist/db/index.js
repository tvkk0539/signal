...
const MockVfsIndexRepository_1 = require("./providers/mock/MockVfsIndexRepository");
...
class DatabaseManager {
    ...
    async instantiateVfsIndexRepository(config) {
        if (config.engine === 'MONGODB') {
            ...
            return new MongoVfsIndexRepository_1.MongoVfsIndexRepository();
        }
        if (config.engine === 'MOCK')
            return new MockVfsIndexRepository_1.MockVfsIndexRepository();
